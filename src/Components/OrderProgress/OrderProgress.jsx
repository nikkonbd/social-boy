const OrderProgress = () => {
  return (
    <div className="bg-[#f46302]">
      <div className="w-5/6 mx-auto text-white py-24">
        <div>
          <h2 className="uppercase text-4xl text-white text-center pb-20">
        ...
        <div className="lg:flex ">
          <div className="text-end lg:border-r-4 lg:border-white pr-6">
            <div>
              ...
              <p className="text-xl">
                Enter the URL where you want to direct the social signals <br />
                and then select the package of your choice from the <br />
                dropdown menu.{" "}
              </p>
            </div>
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-xl">
                We usually complete all of our orders in 3-5 business days.{" "}
                <br />
                You will receive an email from us when we begin <br />{" "}
                processing your order and another one when we <br /> complete it{" "}
              </p>
            </div>
          </div>
          {/*         
          ...
          <div className="mt-10 lg:mt-36 text-start pl-6">
            ...
            <div>
              <div>
                ...
                <p className="text-xl">
                  We wanted to make this as simple as possible for you, so{" "}
                  <br />
                  we only need your email to follow up in case a problem <br />{" "}
                  occurs.
                </p>
              </div>
              <div className="mt-24">
            ...
            <div className="text-end lg:hidden pr-6 my-9">
              ...
              <p className="text-xl">
                ...
                will receive an email from us when we begin processing your
                order and another one when we complete it{" "}
              </p>
            </div>
          </div>
        </div>
